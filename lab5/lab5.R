...
# Сравнение стран по Индексу жизни за последнии 8
...
for(country in my_country){
  ...
  for (year in 2014:2022){
    iter <- c(iter, all_rating[[toString(year)]][all_rating[[toString(year)]][,1] == country,7])# Выбрали индекс качества жизни определенной страны
  }
...
plot(years,index_life[[1]], type='o', lty=1, pch=20, col='brown', cex = 3, cex.axis = 2, cex.lab = 1.5,
     ...
     xlab='Года',
     ylab='Индекс качества жизни', ylim = c(0,15))
